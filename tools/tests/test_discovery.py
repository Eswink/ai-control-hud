...
from tools.discovery import json_metadata, sqlite_schema
...
def test_json_probe_never_includes_values(tmp_path: Path) -> None:
    ...
    auth.write_text(json.dumps({"access_token": "TOP_SECRET_TOKEN", "expires": 123, "nested": {"email": "private@example.com"}}), encoding="utf-8")
