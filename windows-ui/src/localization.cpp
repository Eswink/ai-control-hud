...
std::wstring_view En(TextId id) noexcept {
    switch (id) {
        ...
        case TextId::ZCodeStorage: return L"ZCode source binding";
        case TextId::StorageBinding: return L"Binding";
        case TextId::RuntimeDatabase: return L"Runtime database";
        case TextId::TaskIndex: return L"Task index";
        case TextId::TurnLog: return L"Turn log";
        case TextId::RefreshZCodeSources: return L"Refresh ZCode sources";
        case TextId::Readable: return L"Readable";
        case TextId::Missing: return L"Unavailable";
        case TextId::StorageDefault: return L"Default profile";
        case TextId::StorageCustomData: return L"Custom data path";
        case TextId::StorageCustomRoot: return L"Custom ZCode root";
        case TextId::StorageMachineConfig: return L"Service binding";
...
std::wstring_view Zh(TextId id) noexcept {
    switch (id) {
        ...
        case TextId::ZCodeStorage: return L"ZCode 数据源绑定";
        case TextId::StorageBinding: return L"绑定方式";
        case TextId::RuntimeDatabase: return L"运行数据库";
        case TextId::TaskIndex: return L"任务索引";
        case TextId::TurnLog: return L"实时日志";
        case TextId::RefreshZCodeSources: return L"需要刷新 ZCode 数据源";
        case TextId::Readable: return L"可读";
        case TextId::Missing: return L"不可用";
        case TextId::StorageDefault: return L"默认用户目录";
        case TextId::StorageCustomData: return L"自定义数据路径";
        case TextId::StorageCustomRoot: return L"自定义 ZCode 根目录";
        case TextId::StorageMachineConfig: return L"服务绑定";
