...
std::wstring_view En(TextId id) noexcept {
    switch (id) {
        ...
        case TextId::StartService: return L"Start service";
        case TextId::StopService: return L"Stop service";
        case TextId::RestartService: return L"Restart service";
        case TextId::UpgradeService: return L"Upgrade service";
...
std::wstring_view Zh(TextId id) noexcept {
    switch (id) {
        ...
        case TextId::StartService: return L"启动服务";
        case TextId::StopService: return L"停止服务";
        case TextId::RestartService: return L"重启服务";
        case TextId::UpgradeService: return L"升级服务";
